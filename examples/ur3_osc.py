"""
This code is modified from franka_osc.py by twkim
UR3 Operational Space Control
----------------
Operational Space Control of UR3 robot to demonstrate Jacobian and Mass Matrix Tensor APIs
"""
...
# Parse arguments
args = gymutil.parse_arguments(description="UR3 Tensor OSC Example",
                               custom_parameters=[
