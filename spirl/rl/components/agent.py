...
from spirl.utility.general_utils import ParamDict, get_clipped_optimizer, AttrDict, prefix_dict, map_dict, \
                                        nan_hook, np2obj, ConstantSchedule
from spirl.utility.pytorch_utils import RAdam, remove_grads, map2np, map2torch
from spirl.utility.vis_utils import add_caption_to_img, add_captions_to_seq
...
class HierarchicalAgent(BaseAgent):
    ...
    def act(self, obs):
        ...
        output.update(self.ll_agent.act(self.make_ll_obs(obs_input, self._last_hl_output.action.mean(axis=0, keepdims=True))))
