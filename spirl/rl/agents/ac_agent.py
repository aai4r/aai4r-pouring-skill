...
from spirl.utility.general_utils import ParamDict, map_dict, AttrDict
from spirl.utility.pytorch_utils import ten2ar, avg_grad_norm, TensorModule, check_shape, map2torch, map2np
    ...
    def update(self, experience_batch):
        ...
        for _ in range(self._hp.update_iterations):
            ...
            with torch.no_grad():
                ...
                q_target = experience_batch.reward.squeeze(-1) * self._hp.reward_scale + \
