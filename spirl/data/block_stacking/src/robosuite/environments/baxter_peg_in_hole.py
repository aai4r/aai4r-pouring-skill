...
from spirl.data.block_stacking.src.robosuite.models.objects import CylinderObject, PlateWithHoleObject
from spirl.data.block_stacking.src.robosuite.models.arenas import EmptyArena
